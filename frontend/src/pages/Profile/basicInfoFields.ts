...
export const BASIC_INFO_FIELDS: Record<string, QuestionData> = {
  ...
  hometown: {
    ...
    type: 'dropdown',
    options: [
      { id: 1, text: "🐻‍❄️ 北海道地方", isLabel: true },
      { id: 2, text: "北海道" },
      { id: 3, text: "🍎 東北地方", isLabel: true },
      { id: 4, text: "青森県" },
      { id: 5, text: "岩手県" },
      { id: 6, text: "宮城県" },
      { id: 7, text: "秋田県" },
      { id: 8, text: "山形県" },
      { id: 9, text: "福島県" },
      { id: 10, text: "🏙️ 関東地方", isLabel: true },
      { id: 11, text: "茨城県" },
      { id: 12, text: "栃木県" },
      { id: 13, text: "群馬県" },
      { id: 14, text: "埼玉県" },
      ...
      { id: 16, text: "東京都" },
      { id: 17, text: "神奈川県" },
      { id: 18, text: "🏔️ 中部地方", isLabel: true },
      { id: 19, text: "新潟県" },
      { id: 20, text: "富山県" },
      { id: 21, text: "石川県" },
      { id: 22, text: "福井県" },
      ...
      { id: 34, text: "奈良県" },
      { id: 35, text: "和歌山県" },
      { id: 36, text: "🐉 中国地方", isLabel: true },
      { id: 37, text: "鳥取県" },
      { id: 38, text: "島根県" },
      { id: 39, text: "岡山県" },
      { id: 40, text: "広島県" },
      { id: 41, text: "山口県" },
      { id: 42, text: "🛶 四国地方", isLabel: true },
      { id: 43, text: "徳島県" },
      { id: 44, text: "香川県" },
      { id: 45, text: "愛媛県" },
      { id: 46, text: "高知県" },
      { id: 47, text: "🌺 九州・沖縄地方", isLabel: true },
      { id: 48, text: "福岡県" },
      { id: 49, text: "佐賀県" },
      { id: 50, text: "長崎県" },
      { id: 51, text: "熊本県" },
  ...
  active_stage_role_id: {
    id: 'active_stage_role_id',
    title: '現在の状況',
    description: '',
    type: 'radio',
    allowCustomAnswer: false,
  ...
  study_abroad_interest_level: {
    id: 'study_abroad_interest_level',
    title: '留学への関心度',
    description: '',
    type: 'radio',
    allowCustomAnswer: false,
  ...
  interested_study_abroad_types: {
    id: 'interested_study_abroad_types',
    title: '希望する留学形態',
    description: '',
    type: 'checkbox',
    allowCustomAnswer: true,
  ...
  child_id: {
    id: 'child_id',
    title: 'お子様のユーザーID',
    description: 'TODO: アカウント作成時の自動紐付け（現在はテキスト入力ですが、保存時にエラーになります）',
    type: 'short_text',
    options: [],
    allowCustomAnswer: false,
    scale: { min: 1, max: 5, minLabel: '', maxLabel: '' },
